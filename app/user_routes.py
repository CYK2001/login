...
def create_user_api():
    ...
    # 创建新用户，默认头像使用static/uploads/1.png
    query = "INSERT INTO users (username, password, name, email, phone, gender, role, avatar) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)"
    params = (username, hashed_password, name, email, phone, gender, role, '1.png')
